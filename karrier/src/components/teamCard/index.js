	...
	return (
		<div className={styles.outerCard}>
			...
			<div className={styles.socials}>
				<svg className={styles.svgSource} width="0" height="0" aria-hidden="true">
					<symbol className={styles.svgTwitter} viewbox="0 -7 15 30">
					...
					<symbol className={styles.svgGoogle} viewbox="-13 -13 72 72">
						<path
...
c9.24,0,15.36-6.5,15.36-15.64c0-1.17-0.11-2.29-0.31-3.36C31.05,21,16,21,16,21z"
					...
					<symbol className={styles.svgFacebook} viewbox="0 -7 16 30">
					...
					<symbol className={styles.svgGithub} viewbox="-30 -30 150 150">
						<path
	  ...
	  c3.592,0,6.502-4.028,6.502-8.999C36.605,56.574,33.695,52.548,30.104,52.548z"
					...
					<symbol className={styles.svgPinterest} viewbox="-180 -180 850 850">
						<path
			  ...
			  c23.225,14.136,35.659,28.758,65.268,31.038C384.064,361.207,445.136,243.713,430.149,135.248z"
					...
					<symbol className={styles.svgYoutube} viewbox="-150 -150 800 800">
						<path
		  ...
		  L357,255L204,369.75z"
				...
				<div className={styles.wrapper}>
					<div className={styles.connect}>
						<a href="" className={"${styles.share} ${styles.twitter}"}>
							<svg role="presentation" className={styles.svgIcon}>
								<use xlinkHref=".svgTwitter" />
							</svg>
							<span className={styles.clip}>TWITTER</span>
						</a>

						<a href="" rel="author" className={"${styles.share} ${styles.google}"}>
							<svg role="presentation" className={styles.svgIcon}>
								<use xlinkHref=".svgGoogle" />
								<span className={styles.clip}>GOOGLE +</span>
							</svg>
						</a>

						<a href="" rel="author" className={"${styles.share} ${styles.facebook}"}>
							<svg role="presentation" className={styles.svgIcon}>
								<use xlinkHref=".svgFacebook" />
								<span className={styles.clip}>FACEBOOK</span>
							</svg>
						</a>

						<a href="" className={"${styles.share} ${styles.github}"}>
							<svg role="presentation" className={styles.svgIcon}>
								<use xlinkHref=".svgGithub" />
								<span className={styles.clip}>GITHUB</span>
							</svg>
						</a>

						<a href="" className={"${styles.share} ${styles.pinterest}"}>
							<svg role="presentation" className={styles.svgIcon}>
								<use xlinkHref=".svgPinterest" />
								<span className={styles.clip}>PINTEREST</span>
							</svg>
						</a>

						<a href="" className={"${styles.share} ${styles.youtube}"}>
							<svg role="presentation" className={styles.svgIcon}>
								<use xlinkHref=".svgYoutube" />
								<span className={styles.clip}>YOU-TUBE</span>
							</svg>
						</a>
					</div>
				</div>
